    ...
    <div
      ...
      <div className="content-wrapper">
        ...
        <ul className="intro-list">
          <li>
            Passionate{" "}
            <span className="text-highlight">JavaScript Engineer</span> skilled
            in modern web development.
          </li>
          <li>
            Expertise in <span className="skill-tag">JavaScript</span>,
            <span className="skill-tag">MERN</span>, and{" "}
          ...
          <li>
            Committed to continuous learning and applying best practices in web
            development.
          </li>
        </ul>
      </div>
